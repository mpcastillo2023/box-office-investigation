...
declare const meta: {
    title: string;
    component: ({ textBeside, variant, isThereError, className, refCallback, onChange, customStyles, maxValue, ...props }: {
        textBeside?: string | React.ReactNode;
        variant?: "basic";
        isThereError?: boolean;
        refCallback?: React.RefCallback<HTMLInputElement>;
        onChange?: (value: number | string) => void;
        customStyles?: import("../components/NumberInput/Types/Types").CustomStyles;
        direction?: "row" | "column";
        value?: string | number;
        maxValue?: number;
    } & Omit<React.InputHTMLAttributes<HTMLInputElement>, "type" | "onChange" | "title" | "value">) => React.JSX.Element;
    tags: string[];
    decorators: ((Story: import("@storybook/csf").PartialStoryFn<import("@storybook/react").ReactRenderer, {
        textBeside?: string | React.ReactNode;
        variant?: "basic" | undefined;
        isThereError?: boolean | undefined;
        refCallback?: React.RefCallback<HTMLInputElement> | undefined;
        onChange?: ((value: number | string) => void) | undefined;
        customStyles?: import("../components/NumberInput/Types/Types").CustomStyles | undefined;
...
export declare const DefaultNumberInput: Story;
export declare const NumberInputWithTextBeside: Story;
export declare const NumberInputWithPlaceholder: Story;

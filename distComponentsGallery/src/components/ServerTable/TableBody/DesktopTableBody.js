...
export default function DesktopTableBody({ columns, displayData, translations, tBodyRef, onClickCellHandler }) {
    ...
    if (!displayData || displayData.length < 1)
        return (React.createElement("tbody", { className: styles.bodyContainer },
            React.createElement("tr", null,
                React.createElement("td", { className: styles.notFoundText, colSpan: 5 }, translations.notFound))));
    return (React.createElement("tbody", { className: styles.bodyContainer, ref: tBodyRef }, renderRows()));
}

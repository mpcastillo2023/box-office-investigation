...
type Props = {
    /**
     * Type used in the input field By default is email.
     * @param {"email" | "text" }
     */
    type?: "email" | "text";
    /**
...
declare const EmailInput: ({ label, subLabel, className, placeholder, errorText, isThereError, type, icon, direction, ...props }: Props) => React.JSX.Element;

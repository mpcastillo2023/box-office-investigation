...
export default function InputTableActions({ columns, rowIndex, activeIndex, onCancelHandler, onEditHandler, onRemoveHandler, onSaveHandler, disabled }) {
    ...
    return (React.createElement("div", { key: `${colIndex}-${rowIndex}`, "data-testid": `table-body-cell-${colIndex}-${rowIndex}`, className: `${styles.cell} ${styles.center}` }, activeIndex === rowIndex ? (React.createElement("div", { className: styles.actionButtonsContainer },
